...
namespace BSDSalzburg2024.Data.Migrations
{
    ...
    [Migration("20240808203404_DonorHonorObsolete")]
    partial class DonorHonorObsolete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.Location", b =>
                {
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.Municipality", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("GemeindeID");
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblEhrung", b =>
                {
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblKrankheit", b =>
                {
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblLaborwert", b =>
                {
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblLaborwertName", b =>
                {
                    b.Property<string>("LaborwertNameId")
                        .HasMaxLength(16)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblLogPgm", b =>
                {
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblLogPgmDetail", b =>
                {
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblMitarbeiter", b =>
                {
                    b.Property<string>("MitarbeiterId")
                        .HasMaxLength(12)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblMitarbeiterSpendeaktion", b =>
                {
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblParameter", b =>
                {
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblPostleitzahl", b =>
                {
                    b.Property<string>("Plz")
                        .HasMaxLength(8)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblSpende", b =>
                {
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblSpendeHinderni", b =>
                {
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblSpendeaktion", b =>
                {
                    b.Property<int>("SpendeaktionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblSpendeaktionVerbrauch", b =>
                {
                    b.Property<int>("SpendeaktionId")
                        .HasColumnType("int")
                        .HasColumnName("SpendeaktionID");
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.TblSpender", b =>
                {
                    b.Property<int>("SpenderId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BSDSalzburg2024.Domain.Entities.Location", b =>
                {
                    b.HasOne("BSDSalzburg2024.Domain.Entities.Municipality", "Municipality")
                        .WithMany("Locations")
